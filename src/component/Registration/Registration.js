            ...
            <div className="container-main">
              ...
              <div className="container-item">
                <form>
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      VoterID <span style={{ color: "tomato" }}>*</span>
                      <input
                        className={"input-r"}
                        type="text"
                        placeholder="eg. A896H5643L"
                  ...
                  <p className="note">
                    ...
                    <br /> Make sure your account address and VoterID are
                    correct. <br /> Admin might not approve your account if the
                    provided VoterID does not matches the account
